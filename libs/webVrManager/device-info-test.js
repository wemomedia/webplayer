...
var iOSDevices = {
    iPhone4: new Device({ //added by JM
        width: 640,
        height: 960,
        widthMeters: 0.075,
        heightMeters: 0.0495,
...
var AndroidDevices = {
  ...
  GalaxyS6: new Device({
    ...
    SamsungNote4: new Device({ //added by JM
        userAgentRegExp: /SM-N910/,
        widthMm: 71.12,
        heightMm: 127.0,
        bevelMm: 4.0 //TODO: ?
    })
...
DeviceInfo.prototype.determineIPhone_ = function() {
  ...
  console.error('Unable to detect iPhone type.');
    return iOSDevices[0];//added by JM... better to show something than crash.
  return null;
};
